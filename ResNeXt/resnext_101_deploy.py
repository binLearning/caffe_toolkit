...
def _branch(major, net, bottom, nout, has_branch1=False, is_branch_2a=False):
  ...
  branch2_2a = _block_4in1(major, '2a', net, bottom,     nout,   0, 1, 1)
  branch2_2b = _block_4in1(major, '2b', net, branch2_2a, nout,   1, 3, stride)
  branch2_2c = _block_3in1(major, '2c', net, branch2_2b, nout*2, 0, 1, 1)

  if has_branch1:
    branch1 = _block_3in1(major, '1',  net, bottom, nout*2, 0, 1, stride)
...
def main():
  with open('resnext_101_deploy.prototxt', 'w') as f:
    f.write('name: "ResNeXt-101_deploy"\n')
